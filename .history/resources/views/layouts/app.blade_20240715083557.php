...
<body class="bg-gray-50 font-family-karla">
    ...
    <nav class="fixed top-0 left-0 z-10 w-full text-white shadow-lg bg-gradient-to-r from-blue-900 to-green-600"
        x-data="{ openMobileMenu: false }">
        <div class="container px-6 py-8 mx-auto mb-10 fixed-top">
