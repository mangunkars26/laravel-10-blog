        ...
        <div class="container px-6 mx-auto py-auto">
            <div class="flex items-center justify-between">
                ...
                <div class="container flex items-center justify-between px-6 py-8 mx-auto">
                    <button @click="openMobileMenu = !openMobileMenu" class="mx-auto focus:outline-none sm:hidden">
                    ...
                    <div class="flex flex-col">
                        <a href="{{ route('home') }}" class="flex text-2xl font-bold md:text-normal">
                            <h1>KalibawangMu</h1>
                            {{-- <img src="path/to/logo.png" alt="Brand Logo" class="w-8 h-8 mr-2"> --}}
                        </a>
                        <p class="py-2 px-auto">Media Resmi PCM Dekso Kapanewon Kalibawang</p>
                    </div>
                </div>
