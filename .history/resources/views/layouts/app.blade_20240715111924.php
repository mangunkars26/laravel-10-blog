...
<body class="bg-gray-50 font-family-karla">
    ...
    <nav class="left-0 z-10 w-full text-white shadow-lg bg-gradient-to-r from-blue-950 via-blue-950 to-green-800"
        ...
        <div class="container justify-between items-center px-6 py-8 mx-auto flex">
            <button @click="openMobileMenu = !openMobileMenu" class="focus:outline-none sm:hidden">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path :class="{ 'hidden': openMobileMenu, 'block': !openMobileMenu }" stroke-linecap="round"
        ...
        <div x-show="openMobileMenu" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="space-y-4">
                <input type="text" placeholder="Search..."
                    class="w-full px-4 py-2 text-blue-950 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                <a href="{{ route('home') }}"
