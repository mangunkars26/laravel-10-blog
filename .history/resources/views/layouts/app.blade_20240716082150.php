...
<head>
    ...
    <!-- Font Awesome -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/js/all.min.js" <!-- @vite(['resources/css/app.css', 'resources/js/app.js'])
        @stack('head') < /head>
        <
        ...
        xmlns = "http://www.w3.org/2000/svg" >
            <
            path: class = "{ 'hidden': openMobileMenu, 'block': !openMobileMenu }"
        stroke - linecap = "round"
        stroke - linejoin = "round"
        stroke - width = "2"
        d = "M4 6h16M4 12h16m-7 6h7" > < /path> <
        path: class = "{ 'block': openMobileMenu, 'hidden': !openMobileMenu }"
        stroke - linecap = "round"
        stroke - linejoin = "round"
        stroke - width = "2"
        ...
        svg > <
            ...
            <
            a href = "{{ route('home') }}"
        class = "flex items-center text-xl font-bold md:text-base" >
        <
        ...
        a href = "{{ route('home') }}"
        class =
        "px-2 py-2 transition transform rounded-md shadow-lg hover:bg-white hover:text-blue-900 hover:font-semibold hover:scale-105" >
        Home < /a>
        ...
        div > <
            ...
            <
            a href = "{{ route('login') }}"
        class = "block px-2 py-2 font-semibold text-blue-100 transition rounded-md hover:bg-white hover:text-blue-900" >
        Login < /a> <
        ...
        x - transition: leave = "transition ease-in duration-300"
        class =
        "fixed inset-y-0 left-0 z-30 w-3/4 h-full p-6 bg-gradient-to-r from-blue-950 via-blue-950 to-green-900 md:hidden" >
        <
        !--Close Button-- >
        <
        button @click = "openMobileMenu = false"
        class = "mb-4 text-blue-100 focus:outline-none" >
        <
        svg class = "w-6 h-6"
        fill = "none"
        stroke = "currentColor"
        ...
        <
        a href = "{{ route('home') }}"
        class = "block px-4 py-2 font-semibold text-blue-100 transition rounded-md hover:bg-white hover:text-blue-900" >
        Home < /a>
        @foreach ($categories as $category)
            <
            a href = "{{ route('by-category', $category) }}"
