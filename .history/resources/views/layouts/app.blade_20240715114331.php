            ...
            <div class="flex items-center justify-between">
                ...
                <div class="container flex items-center justify-between px-6 py-8 mx-auto">
                    ...
                    <div class="flex flex-col items-center sm:flex-row sm:space-x-4">
                        <a href="{{ route('home') }}" class="flex items-center text-2xl font-bold md:text-normal">
                            <h1 class="mr-2">KalibawangMu</h1>
                            {{-- <img src="path/to/logo.png" alt="Brand Logo" class="w-8 h-8"> --}}
                        </a>
                        <p class="py-2 text-center sm:text-left sm:py-0">Media Resmi PCM Dekso Kapanewon Kalibawang</p>
                    </div>
                </div>
