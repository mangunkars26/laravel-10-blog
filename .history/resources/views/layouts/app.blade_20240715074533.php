...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        toggleButton.addEventListener('click', function() {
            ...
            const expanded = dropdownMenu.classList.contains('hidden') ? 'false' : 'true';
            toggleButton.setAttribute('aria-expanded', expanded);
        });

        // Tambahkan event listener untuk menutup dropdown saat klik diluar dropdown
        document.addEventListener('click', function(event) {
            const isClickInside = dropdownMenu.contains(event.target) || toggleButton.contains(event
                .target);
