    ...
    <nav class="w-full text-white shadow-lg bg-gradient-to-r from-blue-950 via-blue-950 to-green-800"
        ...
        <div class="container flex items-center justify-between px-6 py-4 mx-auto">
            ...
            <div class="flex flex-col items-start sm:flex-row sm:space-x-4">
                ...
                <p class="text-sm md:text-base">Media Resmi PCM Dekso Kapanewon Kalibawang</p>
            </div>

            <!-- Navigation Links for Desktop -->
            <div class="items-center hidden space-x-6 md:flex">
                <a href="{{ route('home') }}"
                    class="px-4 py-2 transition transform rounded-md shadow-lg hover:bg-white hover:text-blue-900 hover:font-semibold hover:scale-105">Home</a>
                @foreach ($categories as $category)
                    <a href="{{ route('by-category', $category) }}"
                        class="px-4 py-2 transition transform rounded-md shadow-lg hover:bg-white hover:text-blue-900 hover:font-semibold hover:scale-105">{{ $category->title }}</a>
                @endforeach
                <a href="{{ route('about-us') }}"
                    class="px-4 py-2 transition transform rounded-md shadow-lg hover:bg-white hover:text-blue-900 hover:font-semibold hover:scale-105">About
                    Us</a>
            </div>
        </div>
        ...
        <div class="container mx-auto">
            ...
            <div x-show="openMobileMenu" x-transition:enter="transition ease-out duration-900"
                x-transition:leave="transition ease-in duration-300"
