...
<x-app-layout :meta-title="$post->meta_title ?: $post->title" :meta-description="$post->meta_description">
    ...
    <section class="flex flex-col items-center w-full p-4 px-3 mx-auto ml-0 md:w-2/3">
        ...
        <!--user-->
        <div class="flex flex-col w-full p-6 mt-10 mb-10 ml-12 text-center bg-white shadow md:flex-row md:text-left">
            ...
            <div class="flex flex-col justify-center flex-1 md:justify-start md:pl-6">
